...
from nv.model import FastSpeech
from nv.model import Vocoder

if __name__ == "__main__":
    texts = [
        "A defibrillator is a device that gives a high energy electric shock to the heart of someone who is in cardiac arrest",
        "Massachusenv Institute of Technology may be best known for its math, science and engineering education",
    ...
    checkpoint = torch.load("nv_model.pth", device)
